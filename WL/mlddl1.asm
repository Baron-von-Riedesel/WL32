...
; frame thread field
    ...
    mov es:[bx+DGROUP:frame_thrd_meth],al	; save method type in array
    mov es:[di+DGROUP:frame_thrd_index],bp	; save index type to array
...
st_targ:
	...
	add	di,di				; convert to word offset
    pop ax                  ; get thread method value
    mov es:[bx+DGROUP:target_thrd_meth],al	; save method type in array
    mov es:[di+DGROUP:target_thrd_index],bp	; save index type to array
